    ...
    return (
        ...
        <h2>Vì những chuyến xe an toàn của bạn</h2>
          <div className="intro.content" style={{textAlign:'start'}}>
              <p>Công ty quản lý xe khách Nam Hải (Nhà xe Nam Hải) được thành lập vào ngày 09/09/2004. Với hoạt động kinh doanh chính trong lĩnh vực vận tải hành khách và kinh doanh dịch vụ. Nam Hải dần trở thành cái tên quen thuộc trên những nẻo đường của người Việt. </p>
              <p>Trải qua 20 năm hình thành với mục tiêu khách hàng là trọng tâm, chúng tôi tự hào là một trong những doanh nghiệp có chất lượng vận tải tốt nhất tại Việt Nam, góp phần không nhỏ trong việc phát triển kinh tế đất nước lên một tầm cao mới. Luôn cải tiến dịch vụ để mang đến những trải nghiệm tốt nhất cho khách hàng, Công ty có nhiều giải thưởng danh giá như “Thương hiệu số 1 Việt Nam”, “Top 10 dịch vụ hoàn hảo vì quyền lợi người tiêu dùng năm 2024”, “Top 5 thương hiệu - sản phẩm uy tín cho các doanh nghiệp tại Việt Nam năm 2024”...</p>
          </div>
